...
export default function Venue() {
  return (
    <section
      id="venue"
      className="my-36 flex flex-col items-center justify-center overflow-hidden"
    >
      ...
      <div className="mb-20 w-[1007px] text-center font-zilla_slab text-[32px] font-medium text-dark-blue">
