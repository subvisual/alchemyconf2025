    ...
    >
      <div className="w-full max-w-7xl">
        <div className="flex flex-row font-sofia_sans_extra_condensed tablet:gap-40 desktop:gap-52">
          {/* Day 1 Column */}
          <div className="flex flex-col">
            <div className="text-[64px] font-extrabold uppercase leading-[50px] tablet:text-[120px] tablet:leading-[120px] desktop:text-[140px] desktop:leading-[140px] text-dark-blue relative">
              DAY 1
              <span className="absolute left-0 top-0 -z-10 translate-x-[3px] translate-y-[3px] text-[#7D1D3F3D] tablet:translate-x-1 tablet:translate-y-1">
                DAY 1
              </span>
            ...
            <div className="mt-8 w-full font-sofia_sans_extra_condensed tablet:mt-14 desktop:mt-16">
