...
import "./globals.css";
import { koulen, unbutton, zilla_slab, alegreya_sans, sofia_sans_ec } from "@/utils/fonts";
...
export default function RootLayout({
  ...
  return (
    <html
      className={`scroll-smooth ${zilla_slab.variable} ${koulen.variable} ${unbutton.variable} ${alegreya_sans.variable} ${sofia_sans_ec.variable}`}
      lang="en"
    >
      <script
